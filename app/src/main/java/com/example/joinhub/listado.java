...
public class listado extends AppCompatActivity {
    ...
    AdapterView.OnItemClickListener escuchadorparaListView = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent buscar;
            buscar = new Intent(listado.this, datos.class);
        ...
        try {
           ...
           JsonArray listadecosasJSON = jsonObject.getAsJsonArray();
            ...
            for (int punteroevento = 0; punteroevento<arreventos.size(); punteroevento++) {
                JsonObject evento = listadecosasJSON.getAsJsonObject();
                ...
                String categoria;
                categoria = evento.get("categoria").getAsString();
                String subcategoria;
                subcategoria = evento.get("subcategoria").getAsString();
                String Descripcion;
                ...
                Log.d("Listado", "idevento: "+ id + " idusuario: " + idusuario + " categoria: " + categoria + " Subcategoria: "+ subcategoria + " Nombre: "+ Nombre +" Descripcion: " + Descripcion + " Cupo: "+ Cupo+ " Restricciones: "+ Restricciones);
    ...
    class tareaAsincronica extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                URL miRuta = new URL("http://10.152.2.70:60180" + "/api/obtenereventos");
